...
{
    const isAdult = (obj) => (obj.age >= 18 ? 'žmogus yra pilnametis' : 'žmogus yra nepilnametis');
    console.log({
...
{
    const isFullyDescribedPerson = (obj) => (obj.height && obj.weight ? 'Objektas turi ūgį ir svorį' : 'Objektas neturi arba ugio arba svorio arba abiejų');
    console.log({
...
{
    const createInitials = (obj) => `${obj.name[0]}.${obj.surname[0]}.`;
    console.log({
