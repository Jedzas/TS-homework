...
/*
  Union operator (Apjungimo operatorius) yra skirtas aprašytis
  tipus, kurie apjungia kelis kitus tipus
*/
...
console.group('Union operators - užduotys');
{
  ...
  type JoeSchmo = Accommodation[] | Car[];
  // ↑↑↑↑ Tipus apraškite čia ↑↑↑↑
  ...
  {
    // sprendimo pavyzdžius spausdinkite čia
    const carWithAutomatic: Car = {
      transmission: 'Automatic',
      brand: 'audi',
    };
    const carWithManual: Car = {
      transmission: 'Manual',
      brand: 'tesla',
    };
